        ...
        <section className="py-24 bg-[#0a0e1a]">
            <div className="container mx-auto px-4">
                <div className="text-center max-w-2xl mx-auto mb-12">
                    <span className="text-orange-500 font-bold uppercase">Our Expertise</span>
                    <h2 className="text-4xl font-bold font-exo my-4 text-white">Areas Where We Have Experience</h2>
                </div>
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {projectData.map((project, index) => (
                         <div key={index} className="relative group overflow-hidden rounded-lg">
                            ...
                            <div className="absolute inset-0 bg-dark-blue bg-opacity-0 group-hover:bg-opacity-70 transition-all duration-500"></div>
